            ...
            switch ($_SESSION["usergroup"]) {
                case "parent":
                    ...
                    if ($par->get_current_child() == -1) {
                        ...
                        $hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0" href="./downloadMaterial.php">      <i class="fas fa-flag mx-3"></i>        <span class="text-nowrap mx-2">Term Grades</span></a></li>';
