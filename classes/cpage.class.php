			...
			switch ($_SESSION["usergroup"]) {
				case "parent":
					...
					if ($par->get_current_child() == -1) {
						$hidden_menu .= '<li class="nav-item dropdown">
                                            ...
                                            <i class="fas fa-user-graduate mx-3"></i>
                                            <span class="text-nowrap mx-2">Students</span>
                                            <i class="fas fa-caret-down float-none float-lg-right fa-sm">
                                            </i>
                                            </a>
						...
						$hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0"><i class="fas fa-flag mx-3"></i>        <span class="text-nowrap mx-2">Term Grades</span></a></li>';
						$hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0"><i class="fas fa-calendar-alt mx-3"></i>     <span class="text-nowrap mx-2">Timetable</span></a></li>';
						$hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0"><i class="fas fa-list-alt mx-3"></i>    <span class="text-nowrap mx-2">Lecture Topics</span></a></li>';
						...
						$hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0" href="./timetable.php">             <i class="fas fa-calendar-alt mx-3"></i><span class="text-nowrap mx-2">Timetable</span></a></li>';
						...
						$hidden_menu .= '		<li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-flag mx-3"></i><span class="text-nowrap mx-2">Term Grades</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
								<div class="dropdown-menu border-0 animated fadeIn" role="menu">';
						$terms = $par->get_term_list();
						if ($terms) {
							foreach ($terms as $term) {
								$hidden_menu .= '<a class="dropdown-item text-white" role="presentation" href="./checkTermGrades.php?termID=' . $term['ID'] . '"><span>' . $term['Stamp'] . '</span></a>';
							}
							$hidden_menu .= '</div>';
						}
						$hidden_menu .= $hidden_menu_notes_entry;
				...
				case "teacher":
					...
					$hidden_menu .= '		<li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-calendar-alt mx-3"></i><span class="text-nowrap mx-2">Meetings actions</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
								<div class="dropdown-menu border-0 animated fadeIn" role="menu">
								<a class="dropdown-item text-white" role="presentation" href="./addAvailability.php"><span>Add Meeting</span></a>
								<a class="dropdown-item text-white" role="presentation" href="./checkMeetings.php"><span>Check Meetings</span></a>';
					...
					if ($coordinatedClassIDs) {
						$hidden_menu .= '		<li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-users mx-3"></i><span class="text-nowrap mx-2">Class Coordination</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
								<div class="dropdown-menu border-0 animated fadeIn" role="menu">';
				...
				case "officer":
					...
					$hidden_menu .= '       <li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-clock mx-3"></i><span class="text-nowrap mx-2">Timetables</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
                                <div class="dropdown-menu border-0 animated fadeIn" role="menu">
								<a class="dropdown-item text-white" role="presentation" href="./setClassTimetable.php"><span>Manual Insert</span></a>
								<a class="dropdown-item text-white" role="presentation" href="./setClassTimetableCSV.php"><span>CSV Upload</span></a></div>';
