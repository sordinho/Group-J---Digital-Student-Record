...
class officerTest extends TestCase
{
    ...
    {
        $timetable[0][0] = "5|5|insert";
        $timetable[0][1] = "3|13|insert";
        $timetable[0][2] = "6|6|insert";
        $timetable[0][3] = "3|13|insert";
        $timetable[0][4] = "3|13|insert";
        $timetable[0][5] = "0|0|nothing";
        $timetable[1][0] = "8|8|insert";
        $timetable[1][1] = "7|7|insert";
        $timetable[1][2] = "1|1|insert";
        $timetable[1][3] = "1|1|insert";
        $timetable[1][4] = "3|13|insert";
        $timetable[1][5] = "0|0|nothing";
        $timetable[2][0] = "8|8|insert";
        $timetable[2][1] = "3|13|insert";
        $timetable[2][2] = "3|13|insert";
        $timetable[2][3] = "6|6|insert";
        $timetable[2][4] = "2|2|insert";
        $timetable[2][5] = "0|0|nothing";
        $timetable[3][0] = "7|7|insert";
        $timetable[3][1] = "5|5|insert";
        $timetable[3][2] = "8|8|insert";
        $timetable[3][3] = "4|4|insert";
        $timetable[3][4] = "8|8|insert";
        $timetable[3][5] = "0|0|nothing";
        $timetable[4][0] = "3|13|insert";
        $timetable[4][1] = "8|8|insert";
        $timetable[4][2] = "8|8|insert";
        $timetable[4][3] = "2|2|insert";
        $timetable[4][4] = "4|4|insert";
