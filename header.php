...
switch ($_SESSION["usergroup"]) {
    case "parent":
        ...
        $hidden_menu .= '		<li class="nav-item"><a class="nav-link text-left text-white py-1 px-0" href="./listNotes.php"><i class="fas fa-bell mx-3"></i><span class="text-nowrap mx-2">Notes</span></a></li>';
